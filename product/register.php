<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO stock (
            bar_code, medicine_name, category, quantity, remain_quantity, act_remain_quantity, 
            register_date, expire_date, company, sell_type, actual_price, selling_price, 
            profit_price, status
        ) VALUES (
            '$bar_code', '$med_name', '$category', '$quantity', '$quantity', '$quantity',
            '$new_reg_date', '$new_exp_date', '$company', '$sell_type', '$actual_price',
